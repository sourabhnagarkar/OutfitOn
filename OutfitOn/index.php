<?php
session_start(); // This MUST be the first thing before any output
				...
				<nav class="limiter-menu-desktop container">
					...
					<div class="menu-desktop">
						<ul class="main-menu">
							...
							<li>
								<a href="vendor_register.php">Vendor</a>
							</li>
						</ul>
					</div>	
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        $total += $row['price']; // accumulate total price
        echo '
            <li class="header-cart-item flex-w flex-t m-b-12">
                <div class="">
                    <a href="delete_from_cart.php?id=' . $row['id'] . '" onclick="return confirm(\'Are you sure you want to remove this item?\')">
                        <img style="width: 70px;"; src="' . htmlspecialchars($row['photo']) . '" alt="IMG">
                    </a>
                </div>
<center>
    ...
    <div class="p-lr-15 p-t-10">
    
        <h5 class="stext-103 cl3">Total: Rs. ' . number_format($total, 2) . '</h5>
        </center>
    </div>

    <div class="header-cart-buttons flex-w w-full">
        <a href="order.php" class="flex-c-m stext-101 cl0 size-107 bg3 bor2 hov-btn3 p-lr-15 trans-04 m-b-10 w-full text-center">
            Check Out
        </a>
    </div>';
} else {
					...
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
							...
							<div class="layer-slick1 animated visible-false" data-appear="zoomIn" data-delay="1600">
								<a href="showcloth.php" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04">
									Rent Now
								</a>
							</div>
						</div>
