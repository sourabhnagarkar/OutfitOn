    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .left-panel {
            flex: 1 1 300px;
            min-height: 250px;
            background: url('vendor.jpeg') center/cover no-repeat;
...
<div class="container">
    <div class="left-panel">
        <h2>Sign Up</h2>
        <p>Register to list your store on <strong>OutfitOn</strong></p>
    </div>
        
            <form name="vendorForm" action="vendor_register_check.php" method="POST" onsubmit="return validatePassword();">
        ...
        <label>Phone:</label>
        <input type="text" name="phone" id="phone" required pattern="\d{10}" title="Enter 10-digit phone number" />
