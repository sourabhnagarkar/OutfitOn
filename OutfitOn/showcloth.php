			...
			<div class="top-bar">
				<div class="content-topbar flex-sb-m h-full container">
					<div class="left-top-bar">
						Free shipping for standard order over $100wo
					</div>
            ...
            <div class="block2">
                <div class="block2-pic hov-img0">
                    ...
                    <a class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04" 
                      href="productcart.php?pno='.$row['id'].'">
                       Add Cart
                    </a>
                </div>
                ...
                <div class="block2-txt flex-w flex-t p-t-14">
                    <div class="block2-txt-child1 flex-col-l">
                        ...
                        <span class="stext-105 cl3">Rs. '.$row["price"].'</span>
                        <div class="stext-105 cl3">'.$row["description"].'</div>
                    </div>
